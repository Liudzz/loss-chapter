...
if __name__ == '__main__':
    ...
    parser.add_argument('-weights', type=str,default='', required=True, help='the weights file you want to test')
    parser.add_argument('-gpu', type=bool, default=False, help='use gpu or not')
    parser.add_argument('-w', type=int, default=1, help='number of workers for dataloader')
    parser.add_argument('-b', type=int, default=6, help='batch size for dataloader')
